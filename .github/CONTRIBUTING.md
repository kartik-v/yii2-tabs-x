Contributing to yii2-tabs-x
=========================
Looking to contribute something to yii2-tabs-x? **Here's how you can help.**
...
[extension documentation and demos](http://demos.krajee.com/tabs-x) and/or refer to the
[webtips Q & A forum](http://webtips.krajee.com/questions) which are the better places to get help.

Reporting bugs with yii2-tabs-x
-----------------------------
We really appreciate clear bug reports that _consistently_ show an issue
_within yii2-tabs-x_.
...
- What version of jQuery are you using? And what version of yii2-tabs-x?
- Are you using yii2-tabs-x with other plugins?

All of these questions will help others fix and identify any potential bugs.

Requesting features in yii2-tabs-x
------------------------------------------
Before starting work on a major feature for yii2-tabs-x, **read the
[documentation](http://demos.krajee.com/tabs-x)  first** or you may risk spending a considerable amount of
...
yii2-tabs-x regularly receives new issues which need to be tested and organized.
...
If you can test issues that are reported to yii2-tabs-x that contain test cases and
...
It should also be made clear that **all code contributed to yii2-tabs-x** must be
licensable under the [BSD-3 license][licensing].  Code that cannot be released
under this license **cannot be accepted** into the project.

[issue-search]: https://github.com/kartik-v/yii2-tabs-x/search?q=&type=Issues
[issue-tracker]: https://github.com/kartik-v/yii2-tabs-x/issues
[licensing]: https://github.com/kartik-v/yii2-tabs-x/blob/master/LICENSE.md
[reporting-bugs]: #reporting-bugs-with-yii2-tabs-x
[requesting-features]: #requesting-features-in-yii2-tabs-x